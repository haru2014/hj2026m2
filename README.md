...
| --- | --- | --- | --- | --- |
| T2I | Text to Image | 제품 디테일, 구도, 색감 통제에 유리
 ...
 |
| I2V | Image to Video | 기존 이미지의 캐릭터와 제품 형태를 유지한 채 모션 부여 가능
...
| sora-2 | 비디오 변환 | 높음
 ...
 | 달리기와 점프 같은 자연스러운 움직임 구현에 적합

 |
| OpenAI TTS-1 HD | 내레이션 | 높음
 ...
 | 신뢰감 있는 광고 내레이션 제작에 적합

 |
| AI BGM 도구 | 배경음악 | 중간~높음
